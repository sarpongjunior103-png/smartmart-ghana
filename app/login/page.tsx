        ...
        <div className="w-full max-w-md">
          ...
          <Card>
            <CardHeader className="space-y-1">
              ...
              <CardDescription>Sign in to your SmartMart Ghana account</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <Checkbox id="remember" checked={form.remember} onCheckedChange={(v) => setForm((f) => ({ ...f, remember: v as boolean }))} />
              ...
              <p className="mt-2 text-center text-sm text-muted-foreground">
                Are you an admin? <Link href="/admin/login" className="text-primary font-medium hover:underline">Admin Login</Link>
              </p>
            </CardContent>
          </Card>
        </div>
